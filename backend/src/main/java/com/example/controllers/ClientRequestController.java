...
public class ClientRequestController {
    ...
    @RequestMapping(path = "/**/view-feedbacks", method = {RequestMethod.GET})
    ...
    @RequestMapping(path = "/**/institution-feedbacks", method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @PatchMapping(path = "personal-data")
